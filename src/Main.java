...
//        System.out.println("To find the sum of mathematical operations, please enter two numbers.");
//        try {
...
//        try {
//            System.out.println("Please enter a Radius to find it's perimeter and area.");
...
//    try {
//        System.out.println("Please enter a Width and Height to find it's Perimeter and Area.");
...
//        }
    ...
    private static void isEmptystr(String s1)throws Exception {
    ...
    private static void isTwodigit(int num) throws Exception{
        if (num == 00){
            throw new Exception("Please enter at least two digits.");
        }
        if (num < 10 && num > 0){
            throw new Exception("Please enter at least two digits.");
        }
